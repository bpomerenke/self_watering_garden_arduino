...
// Constants
char ap_ssid[] = "LJGuestNet";                  // SSID of network
char ap_password[] = "beourguest";          // Password of network
unsigned int ap_security = WLAN_SEC_WPA2; // Security of network
unsigned int timeout = 30000;             // Milliseconds
char server[] = "onedogdev.com/garden.php";        // Remote host site
